...
import { CrudContext, useIMcrud, CategoryType, ProductType } from "../SSR-inventoryContext";
...
export function InventoryManager() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    //this comp has to only handle preview
  ...
  const fileUpload = async (file: File) => {
    //this component has to conert the file to url.
    if (!file) return;
    setIsUploading(true)
    setError(null);
